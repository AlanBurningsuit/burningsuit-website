...
> **[Figure 1: The agentic system — model, system prompt, harness, and tool results flowing back into context]**
...
> **[Figure 2: The visual validation loop — publish → render → screenshot → back into the agent's context]**
...
> **[Figure 3: Prompt scope vs consequence of failure — the "vibe zone" chart]**
...
> **[Figure 4: The third axis — domain experience steepening the slope]**
