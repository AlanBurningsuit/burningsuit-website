...
On `feat/ownership-redesign`, Alan has confirmed the booking event URL; the essay remains an explicitly authorised placeholder. See `docs/ownership-redesign-implementation.md` for the inputs Alan will replace before release.
