...
const jobs = [
  ...
  // /power-bi hero (swapped to DSC08846 2026-07-28, Alan's pick): source is
  // already hand-cropped to 4:5 portrait (3200×4000), so no extract step.
  ["DSC08846-Edit_cropped.jpg", "DSC08846-Edit_cropped.jpg", 800],
